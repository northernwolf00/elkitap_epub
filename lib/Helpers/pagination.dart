...
class _PagingWidgetState extends State<PagingWidget> {
 ...
 // ========================================================
// COMPLETE WORKING SOLUTION FOR EPUB IMAGES
// This fixes both the WidgetSpan AND TextPainter errors
// ========================================================

// ========================================================
// PART 1: Replace your _parseNode method
// ========================================================
...
// ========================================================
// PART 2: Replace your _paginateFlattened method
// THIS FIXES THE TextPainter ERROR
// ========================================================
...
Future<void> _paginateFlattened(List<InlineSpan> allSpans, Size pageSize) async {
  ...
  for (int i = 0; i < flatSpans.length; i++) {
    ...
    if (span is WidgetSpan) {
      // ✅ FIX: Properly measure WidgetSpan height
      double spanHeight = 0;
      ...
      // ✅ FIX: Always set text before using TextPainter
      TextPainter painter = TextPainter(
...
// KEY FIXES SUMMARY:
// ========================================================
// 1. ✅ Changed all PlaceholderAlignment.baseline to .middle
// 2. ✅ Removed all baseline: TextBaseline.alphabetic
// 3. ✅ Always set TextPainter.text before using it
// 4. ✅ Added try-catch for WidgetSpan measurement
// 5. ✅ Dispose TextPainter after use to prevent memory leaks
// ========================================================
